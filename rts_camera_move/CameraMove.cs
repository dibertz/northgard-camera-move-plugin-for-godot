...
public class CameraMove : Camera
{
    ...
    {
        RTSCamera = GetNode<Camera>("/root/SampleScene/RTSCameraMove3D/SampleScene/TrackingCamera/Camera"); // res://addons/rts_camera_move/SampleScene.tscn
        Go = GetNode<Position3D>("/root/SampleScene/RTSCameraMove3D/SampleScene/TrackingCamera");
        TargetToFollow = GetNode<KinematicBody>("/root/SampleScene/RTSCameraMove3D/SampleScene/Player");
        UILabel = GetNode<Label>("/root/SampleScene/RTSCameraMove3D/SampleScene/Debug/Label");
